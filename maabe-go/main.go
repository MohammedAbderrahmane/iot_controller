...
// //export saveAuth
// func SaveAuth(auth *abe.MAABEAuth) {
...
// func main() {
// 	// e := abe.NewMAABE()
// 	// r,t := e.NewMAABEAuth("zzzz",[]string{"tlemcen:etudiant", "tlemcen:prof", "tlemcen:encadrant"})
// 	// r.g
// 	// maabePK := abe.NewMAABE()

// 	maabeJson, _ := os.ReadFile("maabe-publicKey.json")
// 	maabePK_v2 := LoadPublicParameters(maabeJson)
